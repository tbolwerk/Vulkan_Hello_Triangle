...
private:
	...
	void createLogicalDevice() {
		...
		enabledFeatures.shaderCullDistance = VK_FALSE; // Changed to disabled fixing issue for mac os
	...
	void createGraphicsPipeline() {
		...
		// rasterizationCreateInfo.cullMode = VK_CULL_MODE_BACK_BIT; // Fixes the culling issue not being available on mac os big sur
